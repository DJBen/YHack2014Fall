...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UINavigationBar.appearance().setBackgroundImage(UIImage(named: "nav-bar"), forBarMetrics: UIBarMetrics.Default)
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        AzureManager.sharedManager.deviceToken = deviceToken
    }

    func application(application: UIApplication, didFailToRegisterForRemoteNotificationsWithError error: NSError) {
        println("Fail to register for remote notifications: \(error)")
    }
